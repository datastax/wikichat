    ...
    return <nav className="flex gap-2">
      ...
      <Listbox value={selectedLlm} by="value" onChange={handleChange}>
        <div className="relative ml-auto">
          ...
          <Listbox.Options className="absolute mt-1 w-40 rounded-xl bg-body border p-2">
              {llmOptions.map((llm) => (
              <Listbox.Option
      ...
      <Tooltip anchorSelect="#app-tooltip" clickable>
          Chatting with WikiChat is a breeze!<br></br>
